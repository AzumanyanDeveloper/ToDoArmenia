                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <div class="registration-form-box">
                                    ...
                                    <input type="text" id="exampleInputName1" class="form-control registration-input-box" placeholder="Find Employers...">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="registration-form-box">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="list-grid-item mt-4">
                            <div class="grid-item-content p-2">
                                <div class="employers-list-img mt-3">
                                    <img src="images\employers\img-5.jpg" alt="" class="img-fluid mx-auto d-block rounded-circle">
                                </div>
                                <div class="grid-list-desc text-center mt-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="list-grid-item mt-4">
                            <div class="grid-item-content p-2">
                                <div class="employers-list-img mt-3">
                                    <img src="images\employers\img-6.jpg" alt="" class="img-fluid mx-auto d-block rounded-circle">
                                </div>
                                <div class="grid-list-desc text-center mt-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="list-grid-item mt-4">
                            <div class="grid-item-content p-2">
                                <div class="employers-list-img mt-3">
                                    <img src="images\employers\img-7.jpg" alt="" class="img-fluid mx-auto d-block rounded-circle">
                                </div>
                                <div class="grid-list-desc text-center mt-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="list-grid-item mt-4">
                            <div class="grid-item-content p-2">
                                <div class="employers-list-img mt-3">
                                    <img src="images\employers\img-8.jpg" alt="" class="img-fluid mx-auto d-block rounded-circle">
                                </div>
                                <div class="grid-list-desc text-center mt-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="list-grid-item mt-4">
                            <div class="grid-item-content p-2">
                                <div class="employers-list-img mt-3">
                                    <img src="images\employers\img-9.jpg" alt="" class="img-fluid mx-auto d-block rounded-circle">
                                </div>
                                <div class="grid-list-desc text-center mt-4">
